		...
		document.getElementById('view').innerHTML = html.join('')
			...
			document.onkeydown = function(e){
				switch((e || event).keyCode){
					//(e || event).keyCode)とすると、押されたキーの番号がわかるので、keysleft = truという値をkeysにセットできる
